...
const Embeds = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center px-8 w-full h-[100vh]">
      ...
      <div className="flex items-start justify-between p-8 sm:w-full lg:w-[80%] h-full gap-4">
        ...
        <div className={`flex flex-col gap-8 justify-start items-start h-full py-12 w-[70%] px-10 rounded-xl border border-zinc-300 shadow-lg ${
          theme === "dark" ? "bg-[#1A1C22] text-white" : "bg-white text-black"
        }`}>
