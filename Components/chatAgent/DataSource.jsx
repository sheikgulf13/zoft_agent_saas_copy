    ...
    <SkeletonTheme baseColor="#f5f5f5" highlightColor="#e0e0e0">
      <div className="w-full h-screen">
        ...
        <div className="flex justify-end gap-[8vw]">
          <div
            className={`w-[40vw] mt-[3vw] rounded-[1vw] shadow-xl py-[1.5vw] relative ${
              theme === "dark"
            ...
            >
              ...
              <div className="flex justify-between mb-[4vh]">
                <GradientButton
                  ...
                  className="w-fit bg-gradient-to-r from-[#EB1CD6] to-[#F4A36F] text-white"
                />
                <GradientButton
                  text="Next"
                  icon={FaAngleRight}
          ...
          <div
            className={`w-[25vw] h-screen justify-self-end shadow-xl ${
              theme === "dark"
                ? "bg-[#1F222A] text-white"
                : "bg-white text-black"
            }`}
    ...
    >
      ...
      >
        <div className="w-full h-full flex justify-end items-center gap-[2vw] px-[3vw] pr-[10%]">
          <OutlinedButton onClick={prevReplaceHandler}>Back</OutlinedButton>
          <ContainedButton onClick={nextReplaceHandler}>Create</ContainedButton>
        </div>
      </div>
    </div>
  );
